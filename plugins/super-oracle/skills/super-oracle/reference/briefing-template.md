...
## Output (write to the -o file)
Lead with a one-line verdict (SHIP / DO NOT SHIP, PASS / FAIL). Then a table of
findings: location (`file:line`), issue, severity, exact fix. Quote evidence
verbatim. End with explicit uncertainties and what you could not verify.
